package com.baiye.yudada.service.impl;

import cn.hutool.core.collection.CollUtil;
import com.baiye.yudada.model.enums.AppScoringStrategyEnum;
import com.baiye.yudada.model.enums.AppTypeEnum;
...
import com.baiye.yudada.constant.CommonConstant;
import com.baiye.yudada.exception.ThrowUtils;
import com.baiye.yudada.mapper.AppMapper;
import com.baiye.yudada.model.dto.app.AppQueryRequest;
import com.baiye.yudada.model.entity.App;
import com.baiye.yudada.model.entity.User;
import com.baiye.yudada.model.vo.AppVO;
import com.baiye.yudada.model.vo.UserVO;
import com.baiye.yudada.service.AppService;
import com.baiye.yudada.service.UserService;
import com.baiye.yudada.utils.SqlUtils;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public void validApp(App app, boolean add) {
        ...
        if (StringUtils.isNotBlank(appDesc)) {
            ThrowUtils.throwIf(appDesc.length() > 500, ErrorCode.PARAMS_ERROR, "应用描述长度不能超过500个字符");
        }
    ...
    public QueryWrapper<App> getQueryWrapper(AppQueryRequest appQueryRequest) {
        ...
        // 排序规则
        //SqlUtils.validSortField(sortField):检查传入的排序字段(sortField)是否合法
