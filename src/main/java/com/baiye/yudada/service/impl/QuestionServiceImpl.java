...
import com.baiye.yudada.mapper.QuestionMapper;
import com.baiye.yudada.model.dto.question.QuestionQueryRequest;
...
public class QuestionServiceImpl extends ServiceImpl<QuestionMapper, Question> implements QuestionService {
    ...
    /**
     * 分页获取题目封装
     * 该方法用于将Question对象分页列表转换为QuestionVO对象分页列表
     * 同时关联查询用户信息并填充到VO对象中
     *
     * @param questionPage 分页的Question对象列表
     * @param request      HTTP请求对象，可用于获取请求相关信息
     * @return 返回分页的QuestionVO对象列表，包含题目信息和关联的用户信息
     */
    @Override
    public Page<QuestionVO> getQuestionVOPage(Page<Question> questionPage, HttpServletRequest request) {
        // 从分页对象中获取当前页的记录列表
        List<Question> questionList = questionPage.getRecords();
        // 创建VO分页对象，保持与原分页对象相同的分页参数
