...
import com.baiye.yudada.model.dto.question.QuestionAnswerDTO;
...
/**
 * ClassName: AiTestScoringStrategy
 * Package: com.baiye.yudada.scoring
 * Description:
 *
 * @Author 白夜
 * @Create 2025/11/10 22:06
 * @Version 1.0
 */
    ...
    public UserAnswer doScore(List<String> choices, App app) throws Exception {
        ...
        try {
            ...
            if (lock != null && lock.isLocked()) {
                if (lock.isHeldByCurrentThread()) { //检查锁是否被当前线程持有
                    lock.unlock();
                }
            }
        }
